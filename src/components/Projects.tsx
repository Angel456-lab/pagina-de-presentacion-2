...
const projects = [
  {
    title: 'Task Manager',
    description: 'A web application for managing tasks and projects with real-time updates.',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1115&q=80',
    link: '#'
  },
  {
    title: 'E-commerce Platform',
    description: 'A full-featured online store with advanced product filtering and secure payments.',
  ...
  },
  {
    ...
    description: 'A mobile app for tracking fitness activities and nutrition with personalized insights.',
          ...
          {projects.map((project, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover-lift">
              ...
              <div className="p-6">
                ...
                <a href={project.link} className="text-blue-600 hover:text-blue-800 font-medium transition-colors">View Project</a>
              </div>
            </div>
          ))}
        </div>
